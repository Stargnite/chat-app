...
import { Check, TrashIcon, Ban, Pin } from "lucide-react";
	...
	return (
		<ContextMenu>
			...
			<ContextMenuContent className="flex flex-col justify-around w-[270px] h-72 bg-white p-3 text-gray-800 shadow-lg border-1 border-gray-300">
				<ContextMenuItem className="flex items-center justify-between text-lg cursor-pointer hover:bg-gray-300 transition-all">
					<p>Archive Chat</p>
					<Switch className="bg-gray-600 text-white" />
				</ContextMenuItem>
				<ContextMenuItem className="flex items-center justify-between text-lg cursor-pointer hover:bg-gray-300 transition-all">
